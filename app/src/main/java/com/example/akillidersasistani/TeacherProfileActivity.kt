...
class TeacherProfileActivity : AppCompatActivity() {
    ...
    private fun showGenderPickerDialog() {
        ...
        val btnOther = view.findViewById<MaterialCardView>(R.id.btnGenderOther)
        ...
        btnOther.setOnClickListener {
            ...
            // Profil fotoğrafı olarak genel/nötr bir ikon atayabilirsin
            // binding.imgProfile.setImageResource(R.drawable.ic_anonymous_user)
            dialog.dismiss()
        }
        dialog.show()
    }
